...
export function wrapText(context:any, text:string, x:number, y:number, maxWidth:number, fontSize:number, fontFace:string){
...
useLayoutEffect(()=>{
  if(actions.PageTurn){
   ...
   actions.PageTurn.time = turned? actions.PageTurn.getClip().duration:0;   
