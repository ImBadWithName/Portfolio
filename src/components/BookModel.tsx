...
// type ActionName = "LivreAction" | "KeyAction.002";
// type GLTFActions = Record<ActionName, THREE.AnimationAction>;

// export function BookModel(props: JSX.IntrinsicElements["group"]) {

//   const group = useRef<any>();
//   const { nodes, materials, animations } = useGLTF("/3dModels/book.glb") as GLTFResult;
//   const {actions, mixer} = useAnimations(animations, group);
//   useEffect(()=>{
//     console.log(actions.LivreAction)
//     if(actions.LivreAction){
//      actions.LivreAction.clampWhenFinished =true
//      actions.LivreAction.enabled=true
//     actions.LivreAction.setLoop(THREE.LoopOnce,3)

//       actions.LivreAction.setEffectiveTimeScale(1);
  
//       actions.LivreAction.play()
...
//           <skinnedMesh
//             name="Carnet006"
//             geometry={nodes.Carnet006.geometry}
//             material={materials.Converture}
//             skeleton={nodes.Carnet006.skeleton}
//           />
